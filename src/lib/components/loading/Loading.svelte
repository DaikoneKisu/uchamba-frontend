<div class="fixed z-20 h-screen w-screen bg-black bg-opacity-100">
  <div class="bright flex h-full w-full items-center justify-center gap-3">
    <div class="yellow-bright">
      <div class="hive yellow-hive bright aspect-[65/220] w-[65px] bg-ucab-yellow"></div>
    </div>
    <div class="green-bright">
      <div class="hive green-hive aspect-[65/220] w-[65px] bg-ucab-green"></div>
    </div>
    <div class="blue-bright">
      <div class="hive blue-hive aspect-[65/220] w-[65px] bg-ucab-blue"></div>
    </div>
  </div>
</div>
...
<style>
  ...
  .yellow-bright {
    --color: theme('colors.ucab-yellow');
    animation: 2s bright infinite;
  }

  .green-bright {
    --color: theme('colors.ucab-green');
    animation: 2s bright 0.66s infinite;
  }

  .blue-bright {
    --color: theme('colors.ucab-blue');
