...
<Dropdown title="Habilidades Blandas">
  ...
  >
    <div class="flex w-full justify-center gap-12">
      <label
        class="mt-4 flex h-[49px] w-full max-w-[330px] justify-center rounded-xl border-4 border-[#f0f0f0] bg-brand-white pr-4"
      >
        <div class="flex h-full w-full flex-col justify-center pl-5 text-[15px]">
          <input
            ...
            class="bg-stone-50 text-sm placeholder:text-brand-p-black focus:border-0 focus:shadow-none focus:outline-none"
          />
        </div>
      </label>
    </div>
  ...
  <div class="w-full">
    <ul class="flex w-full flex-wrap items-center justify-center gap-2 pt-3">
